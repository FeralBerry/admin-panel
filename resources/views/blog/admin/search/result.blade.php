                                ...
                                <div class="product-main simpleCart_shelfItem">
                                    <a href="#" class="mask">
                                        @if(empty($product->img))
                                            <img class="img-responsive room-img" src="{{ asset('/images/no_image.jpg') }}" alt=""/>
                                        @else
                                            <img class="img-responsive room-img" src="{{ asset("/uploads/single/$product->img") }}" alt=""/>
                                        @endif
                                    </a>
