        ...
        <div class="row">
            <div class="col-md-12">
                    ...
                    <form action="{{ route('shop.admin.users.update', $item->id) }}" method="post" data-toggle="validator">
                        ...
                        <div class="box-body">
                            <div class="form-group has-feedback">
                                <label for="login">Логин <small>меняется автоматически</small></label>
                            ...
                            <div class="form-group has-feedback">
                                ...
                                <select name="role" id="role" class="form-control">
                                    ...
                                    <option value="1" @php if($role == 'admin') echo ' selected'@endphp>Администратор</option>
                                    <option value="3" @php if($role == 'customer') echo ' selected'@endphp>Заказчик</option>
                                    <option value="4" @php if($role == 'student') echo ' selected'@endphp>Студент</option>
                                    <option value="5" @php if($role == 'teacher') echo ' selected'@endphp>Учитель</option>
                                </select>
                            </div>
                        </div>
                ...
                <div class="text-center">
                    <p>{{ count($count_orders) }} заказов из {{ $count }}</p>
