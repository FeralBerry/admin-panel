                            ...
                            <table class="table table-bordered table-hover">
                                ...
                                @forelse($paginator as $order)
                                    ...
                                    <tr class="{{ $class }}">
                                        ...
                                        <td>
                                            <a href="{{ route('shop.admin.orders.edit', $order->id) }}" title="редактирование заказа"><i class="fa fa-fv fa-eye"></i></a>
                                            <a href="{{ route('shop.admin.orders.forcedestroy', $order->id) }}" title="удалить из БД"><i class="fa fa-fv fa-close text-danger deleted"></i></a>
                                        </td>
                                    </tr>
                                    @empty
                                    <tr>
