        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-xs-6">
                <div class="small-box bg-green">
                    ...
                    <a href="{{ route('shop.admin.products.index') }}" class="small-box-footer">More info
                    <i class="fa fa-arrow-circle-right"></i></a>
                </div>
            </div>
            <div class="col-lg-3 col-xs-6">
                <div class="small-box bg-yellow">
                    ...
                    <a href="{{ route('shop.admin.users.index') }}" class="small-box-footer">More info
                        <i class="fa fa-arrow-circle-right"></i></a>
                </div>
            </div>
            <div class="col-lg-3 col-xs-6">
                    ...
                    <a href="{{ route('shop.admin.categories.index') }}" class="small-box-footer">More info
                        <i class="fa fa-arrow-circle-right"></i></a>
                </div>
            </div>
        </div>
